...
public class Day293 {
    public static void main(String[] args) {
        int[] a ={2,1,43,45,76,78,98,54,56,678,87,87,56,67,87,564,4};
        //bubbleSort(a);
       // selectSort(a);
       // insertSort(a);
        quickSort(a,0,a.length-1);
        System.out.println(binarySeach(a,0,a.length,2332));
    ...
    public static int binarySeach(int[] a,int start,int end,int k){
        int lo= start;
        int hi = end-1;
        while (lo<=hi){
            int mid = (lo+hi)>>>1;
