...
public class Day115 {
    public static void main(String[] args) {
        int[] a= {2,1,5,87,45,8,90,0,5,7,76,43,343,32,2,98};
        //bubbleSort(a);
        //selectSort(a);
        //insertSort(a);
        quickSort(a,0,a.length-1);
        System.out.println(binarySearcj(a,0,a.length,4));
    ...
    public static int binarySearcj(int[] a,int start,int end,int k){
        int lo  = start;
        int hi = end;
        while (lo<=hi){
            int mid = (lo+hi)>>>1;
