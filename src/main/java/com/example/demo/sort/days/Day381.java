...
public class Day381 {
    public static void main(String[] args) {
        int[] a = {2,1,34,34,65,76,78,34,65,45,65,343,3};
        //bubbleSort(a);
      //  selectSort(a);
       // insertSort(a);
        quickSort(a,0,a.length-1);
        System.out.println(binarySeqarch(a,0,a.length,35432));
    ...
    public static int binarySeqarch(int[] a,int start,int end,int k){
        int lo = start;
        int hi = end-1;
        while (lo<=hi){
            int mid = (lo+hi)>>>1;
